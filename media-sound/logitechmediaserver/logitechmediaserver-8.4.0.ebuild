...
PATCHES=(
	"${FILESDIR}/LMS-8.4.0_replace_UUID-Tiny_with_Data-UUID.patch"
	"${FILESDIR}/LMS-8.4.0-perl-recent.patch"
	"${FILESDIR}/LMS-8.4.0_remove_softlink_target_check.patch"
	"${FILESDIR}/LMS-8.4.0_move_client_playlist_path.patch"
)
