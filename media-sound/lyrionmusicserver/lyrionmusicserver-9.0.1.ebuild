...
PATCHES=(
	"${FILESDIR}/LMS-9.0.1_replace_UUID-Tiny_with_Data-UUID.patch"
	"${FILESDIR}/LMS-9.0.1_perl-recent.patch"
	"${FILESDIR}/LMS-9.0.1_remove_softlink_target_check.patch"
	"${FILESDIR}/LMS-9.0.1_move_client_playlist_path.patch"
)
